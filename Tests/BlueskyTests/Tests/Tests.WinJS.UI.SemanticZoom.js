        ...
        return test.doAsync(function (onTestComplete) {
            ...
            WinJS.UI.Pages.render("/Tests/supportFiles/semanticZoom/simpleZoom.html", target).then(function (testPage) {
                ...
                WinJS.Promise.timeout(1000).then(function () {
                    ...
                    test.assert($zoomedInContainer.css("width") == "600px", "$zoomedInContainer width incorrect");
                    ...
                    test.assert($zoomedOutContainer.css("width") == "600px", "$zoomedInContainer width incorrect");
            ...
            WinJS.UI.Pages.render("/Tests/supportFiles/semanticZoom/simpleZoom.html", target).then(function (testPage) {
                ...
                WinJS.Promise.timeout(1000).then(function () {
                    ...
                    return new WinJS.Promise(function (onComplete) {
                        ...
                        var $button = $(".win-semanticzoom-button");
                        test.assert($button.length == 0, "Zoomed, shouldn't have");

                        // Click the button and ensure it doesn't zooms out
                        sz.onzoomchanged = function () {
                            var $button = $(".win-semanticzoom-button");
                        }
                        $button.click();
