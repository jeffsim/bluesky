...
WinJS.Namespace.define("ExtendedSplash", {
    show: function (splash, image) {
        ...
        extendedSplashProgress.style.marginTop = splash.imageLocation.y + splash.imageLocation.height + 15 + "px";
    ...
    updateImageLocation: function (splash) {
        if (isVisible()) {
            var extendedSplashImage = document.getElementById("extendedSplashImage");
